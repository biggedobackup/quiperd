  ...
  return (
    <>
      ...
      <Cascade className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <ElementCascade className="h-full"><StatCard libelle="Litiges ouverts" valeur={s.litigesOuverts} icone={icone.litige} pied={s.litigesOuverts > 0 ? <Link to="/admin/litiges" className="inline-flex min-h-11 items-center underline">À arbitrer</Link> : 'Aucun en attente'} /></ElementCascade>
