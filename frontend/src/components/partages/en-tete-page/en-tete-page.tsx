...
export function EnTetePage({ surtitre, titre, description, actions }: { surtitre?: string; titre: string; description?: ReactNode; actions?: ReactNode }) {
  return (
    <div className="mb-6 flex flex-col gap-4 border-b-2 border-encre pb-5 md:flex-row md:items-end md:justify-between">
      <div className="min-w-0">
        {surtitre && <span className="etiquette text-muet">{surtitre}</span>}
        <h2 className="mt-1 text-h1">{titre}</h2>
