...
function ConnexionAdmin() {
  ...
  return (
    <main className="motif-grille flex min-h-dvh items-center justify-center bg-craie px-4 py-10">
      <Apparition className="w-full max-w-sm">
        <div className="mb-6 flex items-center justify-between">
          <Logo />
          <span className="etiquette bg-volt px-2 py-1 text-nuit">Administration</span>
        </div>
        <form onSubmit={soumettre} className="ticket space-y-4 border-2 border-encre bg-papier p-6 shadow-tampon" noValidate>
